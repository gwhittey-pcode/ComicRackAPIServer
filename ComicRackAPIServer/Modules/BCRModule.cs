...
namespace BCR
{
    ...
    {
        public BCRModule()
          : base(Database.Instance.GlobalSettings.url_base + "/API")
        {
            ...
            */
            ...
            Get["/Comics/{id}/File"] = x => {
                ...
                try
                {
                    ...
                    PropertyInfo FilePath = book.GetType().GetProperty("FilePath");
                    PropertyInfo Series = book.GetType().GetProperty("Series");

                    var zipPath = @"J:\Comics\Alphabetical\E\Eternals (Marvel)\Eternals 009 (2009) (digital) (Minutemen-Excelsior).cbz";
